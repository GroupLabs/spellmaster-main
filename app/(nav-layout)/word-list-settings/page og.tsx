  ...
  return (
    <Stack spacing={"11px"} alignItems={"center"} paddingBottom={"32px"}>
      <Typography fontSize={"18px"}>
        Step 1: Simply enter three vocabulary words, AI will generate a word
        list based on these inputs
      </Typography>
      {
  ...
  return (
    <Stack spacing={"11px"} alignItems={"center"}>
      ...
      <Stack alignItems={"center"} paddingTop={"48px"}>
        <Typography>
          Once published, your students can choose from multiple game modes as
          they gain mastery through repetition
        </Typography>
        <GameSelector />
      </Stack>
      <BeatLoader loading={isGenerating} />
  ...
  return (
    ...
    >
      <Typography fontWeight={"bold"} fontSize={18}>
        Share this link for students to play instantly
      </Typography>
      <Stack
        direction={"row"}
        alignItems={"center"}
