  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography fontWeight={"bold"} fontSize={"24px"}>
            Why Choose Spokabulary?
          </Typography>
          <Stack>
            <Stack direction={"row"} spacing={"8px"} alignItems={"center"}>
              <CheckCircle />
              <Typography fontSize={"16px"}>
                Teachers can create custom word lists in just seconds (with a boost from AI)
              </Typography>
            </Stack>
            <Stack direction={"row"} spacing={"8px"} alignItems={"center"}>
              <CheckCircle />
              <Typography fontSize={"16px"}>
                Students have their choice of games which use YOUR word list
              </Typography>
            </Stack>
            <Stack direction={"row"} spacing={"8px"} alignItems={"center"}>
              <CheckCircle />
              <Typography fontSize={"16px"}>
                Perfect for a fun, interactive experience, both in and outside of the classroom
              </Typography>
            </Stack>
          </Stack>
        </Stack>*/}
      ...
      <Stack alignItems={"center"} paddingTop={"24px"}>
      <Typography fontWeight={"bold"} fontSize={"28px"}>
            Your weekly word lists - gamified! 
          </Typography>
        <GameSelector />
      </Stack>
    </Stack>
    ...
    >
      ...
      <Grid item xs={1}>
        <Stack spacing={"8px"}>
          ...
          <Link href="/terms-of-use.html" style={{ width: "fit-content" }}>
            <Typography fontSize={"16px"}>Terms</Typography>
          </Link>
          <Link href="/privacy-policy-sk.html" style={{ width: "fit-content" }}>
